export type Color = "red" | "blue" | "yellow" | "green" | "purple" | "orange" | "pink" | "gray" | "darkgray" | "black" | "white" | "ghost"
...
export const colors: Record<Color, { cls: string }> = {
  ...
  'darkgray': { cls: 'bg-neutral-500 shadow-neutral-600 dark:bg-neutral-800 dark:shadow-neutral-900 text-neutral-900 dark:text-neutral-100' },
